...
class configBlckLst(threading.Thread):
	...
	def run(self):
		...
		try:
			...
			print("\033[31mYour input isn't correct (between 1 and 4)\nError : "+str(e)+"\033[0m")
		if action == 1:
			...
			while 1:
				...
				try:
					...
					print("\033[31mYour input isn't correct. (between 1 and 5)\nError : "+str(e)+"\033[0m")
			error = BDD.ajouterEntree("BlackList", entree, rank)
			if error == 0:
				print("\033[32m"+str(entree) + " has been added in the BlackList with the rank " + str(rank)+"\033[0m")
			else:
				print("\033[31mAn error occured. Look at the logs for more informations. ("+str(error)+")\033[0m")
		elif action == 2:
			entree = autresFonctions.ask("What do you want to delete in your BlackList ?")
			error = BDD.supprEntree("BlackList", entree)
			if error == 0:
				print("\033[32m"+str(entree) + " has been deleted in the BlackList\033[0m")
			else:
				print("\033[31mAn error occured. Look at the logs for more informations. ("+str(error)+")\033[0m")
		elif action == 3:
			...
			if ipport == "":
				...
				print("\033[31mThis is not a IP:PORT\033[0m")
		elif action == 4:
			...
			if autresFonctions.verifIPPORT(value):
				...
				print("\033[31mYour input isn't a IP:PORT\033[0m")
		else:
			print("\033[31mYour input isn't correct.\033[0m")
